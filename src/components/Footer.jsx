...
function Footer() {
  return (
    <div className="w-full h-screen flex bg-zinc-100 p-20">
        <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
            <h1 className="uppercase font-['Roboto'] text-black font-semibold text-[7vw] -mb-5 tracking-tighter leading-none">Eye-</h1>
            <h1 className="uppercase font-['Roboto'] text-black font-semibold text-[7vw] -mb-5 tracking-tighter leading-none">Opening</h1>
            
        </div>
        <svg className="text-black" width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="w-1/2">
        <h1 className="uppercase font-['Roboto'] text-black font-semibold text-[6vw] -mb-5 tracking-tighter leading-none">Presentations</h1>
        <div className="dets font-['Roboto'] mt-10 text-black">
